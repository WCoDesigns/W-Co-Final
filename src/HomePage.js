  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: "30px", fontWeight: 800, letterSpacing: "-1px", color: brand.white }}>
            W&Co Designs
          </div>
          <nav
            style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {[
                  ["Midnight Sky", "Deeper contrast and stronger brand presence"],
                  ["Australian Made", "Locally crafted for project durability"],
                  ["Specified for Interiors", "Suitable for workplace and hospitality use"],
                ].map(([title, text]) => (
                  <div
                    key={title}
                    style={{
                  ...
                  >
                    <div style={{ color: brand.white, fontWeight: 700, marginBottom: "8px" }}>
                      {title}
                    </div>
        ...
        >
          {[
            ...
            <div key={index} style={cardStyle}>
              ...
              <h3 style={{ fontSize: "28px", margin: "0 0 12px 0", color: brand.midnightSky }}>{title}</h3>
        ...
        >
          ...
          >
            ...
            >
              ...
              <h3 style={{ fontSize: "24px", marginBottom: "10px", color: brand.midnightSky }}>Melbourne Tech Hub</h3>
            ...
            >
              ...
              <h3 style={{ fontSize: "24px", marginBottom: "10px", color: brand.midnightSky }}>
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.78)", maxWidth: "620px", lineHeight: 1.7 }}>
